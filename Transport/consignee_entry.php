  ...
  <div class="container">
    <?php
      if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO consignee (consignee_name,consignee_address1,consignee_address2,consignee_address3,consignee_landmark,consignee_city,consignee_state,consignee_country,consignee_pin,consignee_phone,consignee_mobile,consignee_email,consignee_website,consignee_gstin,consignee_pan) VALUES('$name','$address1','$address2','$address3','$landmark','$city','$state','$country','$pin','$phone','$mobile','$email','$website','$gstin','$pan')";
        if(mysqli_query($conn,$query)){
          echo "<div class='alert alert-success alert-dismissible fade show mt-2' role='alert'>
            consignee successfully created.
      ...
      mysqli_close($conn);
    ?>
    <form class="my-4" method="post" action="consignee_entry.php">
      <h5 class="text-center text-uppercase mb-4">create consignee</h5>
      <div class="row">
        <div class="col-sm">
          <div class="form-group">
            <label for="name">Name *</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Enter consignee name" required>
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
